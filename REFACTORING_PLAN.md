...
### 1.2 Дублированный ParameterRow
...
### 1.3 Избыточная архитектура сервисов
...
- [ ] Удаление дублированного ParameterRow
- [ ] Упрощение архитектуры сервисов
